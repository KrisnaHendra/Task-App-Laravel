    ...
    <div class="block block-rounded block-bordered">
        ...
        <div class="block-content">
            <div class="row">
              ...
              <!--  -->
              <div class="col-md-3">
                  <a class="block block-rounded block-link-rotate" href="{{ url('task') }}">
                                    ...
                                    <div class="block block-bordered mb-1">
                                        <div class="block-header block-header-default bg-primary mb-0" role="tab" id="faq1_h2" style="height:30px">
                                            <a class="text-muted collapsed text-white col-12 font-weight-bold mb-0" data-toggle="collapse" data-parent="#faq1" href="#faq1_q2" aria-expanded="true" aria-controls="faq1_q2">
                                              <i class="fa fa-angle-double-down"></i> {{$key}} ({{$value['id_project']}} Task)
                                            </a>
                                        </div>
                                            ...
                                            <div class="block-content mt-0 pt-1">
                                                <table class="mt-0 table-sm font-sm col-12" style="font-size:13px;">
                                                  ...
                                                  <tr style="border-bottom:1px solid #c9c9c9;">
                                                    <td class="pb-2 pl-0" style="width:40px; height:100%; vertical-align: center;">
                                                      <div class="row pr-0">
                                                        <div class="col-4 p-0 m-0">
                                                          <form action="{{ url('task/updateUncomplete') }}" method="post">
                                                            {{ csrf_field() }}
                                                            <input type="hidden" name="id_task" value="{{ $value2['id'] }}">
                                                            <button type="submit" class="btn btn-sm btn-outline-warning p-0 m-0 pl-1 pr-1" name="button" data-toggle="tooltip" data-placement="top" title="" data-original-title="Undo"><i class="fa fa-undo"></i></button>
                                                          </form>
                                                        </div>
                                                        <div class="col-4 pl-2 p-0 m-0">
                                                          <form action="{{ url('task/updateComplete') }}" method="post">
                                                            {{ csrf_field() }}
                                                            <input type="hidden" name="id_task" value="{{ $value2['id'] }}">
                                                            <button type="submit" class="btn btn-sm btn-outline-primary p-0 m-0 pl-1 pr-1" name="button" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="Done"><i class="fa fa-check-circle"></i></button>
                                                          </form>
                                                        </div>
